...
export RK_PARTITION_CMD_IN_ENV="256K(env),256K@256K(idblock),512K(uboot),128K(fdt),128K(fdtfast),5M(boot),29M(oem),10M(userdata),80M(rootfs)"
...
# enable legarcy image start
export LUCKY_ENABLE_LEGACY_IMG=y
